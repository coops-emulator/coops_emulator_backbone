...
export function startServer(rootDir, port = 0) {
  const server = http.createServer((req, res) => {
    ...
    // credentialless, matching deploy/ (see deploy/README.md "Why
    // credentialless, not require-corp") - using require-corp here would
    // test against a header combination this project no longer recommends,
    // and would silently break fetches to the real cdn.emulatorjs.org CDN
    // this e2e suite hits, since it doesn't send back a
